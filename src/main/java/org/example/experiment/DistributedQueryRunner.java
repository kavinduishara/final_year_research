...
public class DistributedQueryRunner {
    ...
    public static DistributedExecutionResult execute(
        //Output : DistributedExecutionResult(metrics + result rows)
        ...
        SplitResult split =
                ...
                //cut plan at JOIN node
        //Output : SplitResult(fragment1, fragment2)
        ...
        // FragmentSqlBuilder.build() — RelNode → Postgres SQL
        //Output : FragmentSql(dropSql, createSql, tempTableName)
        ...
        //TableDistribution : map of table to worker
        //Output : TableDistribution(table1 -> worker1, table2 -> worker2)
        ...
        //DistributedExecutor.execute() — FragmentSql, CutCandidate, TableDistribution → DistributedExecutionResult
        ...
        //DistributedExecutor.execute() — run on worker1/worker2, ship data
        //Output : DistributedExecutionResult(metrics + result rows)
